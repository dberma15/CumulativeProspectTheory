...
reducedChiSquare<-sum(chiSquareElement)/(6*subsetOfSubjects)
reducedChiSquare
...
write.table(covariancematrix,"C:\\Users\\Daniel\\Documents\\R\\Rstan_covariancemat_dataset18_all_0.xls",sep="\t")
write.table(invCovarianceMatrix,"C:\\Users\\Daniel\\Documents\\R\\Rstan_invcovariancemat_dataset18_all_0.xls",sep="\t")
write.table(alpha,"C:\\Users\\Daniel\\Documents\\R\\Rstan_alphaestimate_dataset18_all_0.xls",sep="\t")
write.table(beta,"C:\\Users\\Daniel\\Documents\\R\\Rstan_betaestimate_dataset18_all_0.xls",sep="\t")
write.table(delta,"C:\\Users\\Daniel\\Documents\\R\\Rstan_deltaestimate_dataset18_all_0.xls",sep="\t")
write.table(gamma,"C:\\Users\\Daniel\\Documents\\R\\Rstan_gammaestimate_dataset18_all_0.xls",sep="\t")
write.table(lambda,"C:\\Users\\Daniel\\Documents\\R\\Rstan_lambdaestimate_dataset18_all_0.xls",sep="\t")
write.table(luce,"C:\\Users\\Daniel\\Documents\\R\\Rstan_luceestimate_dataset18_all_0.xls",sep="\t")
...
write.table(allChiSquares,"C:\\Users\\Daniel\\Documents\\R\\Rstan_AllChiSquaresValues_dataset18_all_0.xls",sep="\t")
